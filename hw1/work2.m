...
hold on;                                                    % 保持图形                                                 
title('真空中两个等量异性点电荷的电位分布(11910103 秦庆福)','fontsize',20);      % 绘制出图形标题
...
figure(3);                                                  % 在图像窗口3绘图
streamline(X(:,1:1:31),Y(:,1:1:31),Ex(:,1:1:31),Ey(:,1:1:31),xs1,ys);                               % 生成q1产生的左半部分的电力线
streamline(X(:,30:1:60),Y(:,30:1:60),-Ex(:,30:1:60),-Ey(:,30:1:60),xs2,ys);                               % 生成q2产生的右半部分的电力线
grid on;                                                    % 形成网格
hold on;                                                    % 保持图形
